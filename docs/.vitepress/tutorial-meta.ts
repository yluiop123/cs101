...
export const tutorialSeries: SeriesMeta[] = [
  ...
  },
  {
    ...
    tutorials: [
      ...
      { slug: 'typescript', title: 'TypeScript 教程', description: '静态类型系统：接口、泛型与工程化配置', chapters: 10, status: 'building' },
      { slug: 'tailwind', title: 'Tailwind CSS 教程', description: '原子化 CSS 框架：工具类体系、响应式与主题定制', chapters: 8, status: 'building' },
      { slug: 'vite', title: 'Vite 教程', description: '下一代前端构建工具：DevServer、插件与构建优化', chapters: 6, status: 'building' },
      { slug: 'vue', title: 'Vue 3 教程', description: '渐进式框架：组合式 API、组件化、路由与 Pinia', chapters: 12, status: 'building' },
      { slug: 'react', title: 'React 教程', description: '声明式 UI：Hooks、组件通信、路由与状态管理', chapters: 12, status: 'building' },
      { slug: 'angular', title: 'Angular 教程', description: '企业级框架：依赖注入、RxJS、路由与表单', chapters: 12, status: 'building' },
    ],
  },
  {
    id: 'backend',
